 ...
 return x = x.add(hasUpgrade('b',11)?buyableEffect("b",11):0).mul(player.b.lineZeroLength.mul(player.b.lineLength.gte(30)?buyableEffect("b",12):0).add(1).pow(new Decimal(0.75)))
    ...
    infoboxes: {
        eff: {
            ...
            if (hasUpgrade("b", 13)) return  "Your ternary code: <br>" + player.b.binary + " (Length: " + format(player.b.lineLength) + " Digits)<br>" + next + "<br>Amount of <b>0</b> in code: Increases point gain by " + format(tmp.b.zEffect) + "x. <br> Amount of <b>1</b> in code: Reduces extend cost by /" + format(tmp.b.oEffect) + "<br> Amount of <b>2</b> in code: Boosts binaries gain by "+ format(tmp.b.tEffect) + "x <br>Formulas: <br>" + bin + "<br>" + ter
               else return "Your binary code: <br>" + player.b.binary + " (Length: " + format(player.b.lineLength) + " Digits)<br>" + next + "<br>Amount of <b>0</b> in code: Increases point gain by " + format(tmp.b.zEffect) + "x. <br> Amount of <b>1</b> in code: Reduces extend cost by /" + format(tmp.b.oEffect) + "<br>Formulas: <br>" + bin + "<br>" + ter },
        },
    },
    upgrades: {
        11: {
